...
@section('content')
        ...
        <div class="container-lg">
            ...
            <div class="col-3 text-center">
                ...
                <p style="font-size: 1rem; font-weight: bolder;">{{$question->question}}</p>
            </div>
            </div>
                <div class="jawaban">
                    <div class="jwb">
                        <input type="radio" id="Ya" name="next" value="Ya">
                        <label for="Ya">Ya</label>
                    </div>
                    <div class="jwb">
                        <input type="radio" id="Mungkin" name="next" value="HTML">
                        <label for="Mungkin">Mungkin</label>
                    </div>
                    <div class="jwb">
                        <input type="radio" id="Tidak" name="next" value="HTML">
                        <label for="Tidak">Tidak</label>
                    </div>
                    <a type="button" class="btn btn-primary toastsDefaultDefault" href="{{url('/answer')}}">
                        Submit
                      </a>
                </div>
        </div>
